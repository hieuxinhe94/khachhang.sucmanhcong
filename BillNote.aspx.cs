...
public partial class Customer_BillNote : System.Web.UI.Page
{
    ...
    public DataTable getCustomerBillInformation(int Id)
    {
        try
        {
            ...
            Cmd.CommandText = "SELECT 0 AS TT, *, ISNULL(IdNote,0) AS IdNote1, (SELECT TOP 1 tblPartner.Name FROM tblPartner WHERE Account = PartnerAccount) AS PartnerName FROM tblPartnerBill WHERE Id = @Id";
