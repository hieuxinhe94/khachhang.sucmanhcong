...
public partial class Customer_CustomerBill : System.Web.UI.Page
{
    ...
    public string strHtml = "", strDSInDay = "", strDSInWeek = "", strDSInMonth = "", strDSTotal = "", strDSCard = "", strTichLuyThe = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Page.IsPostBack)
        {
            ...
            Response.Redirect("/CustomerBill" + rurl);
                }
            else {
            try
            {
            ...
            if (this.objTable.Rows.Count > 0)
            {
                for (int i = 0; i < this.objTable.Rows.Count; i++)
                {
                    ...
                    strHtml += "<div  id=\"tt3\" style=\"width: 13%; float: left; border:solid 1px #f3f1f1;border-top:none;text-align:center;height:26px; line-height:26px; color:#000;\">";
                    ...
                    strHtml += "<a href = \"BillNote.aspx?id=" + this.objTable.Rows[i]["Id"].ToString() + "\"><img src = \"../img/Edit.png\" alt = \"Chi tiết\" title = \"Chi tiết hoá đơn\"></a>";
                    strHtml += "</div>";
    ...
    public double getCustomerTotalDiscountCard(string CustomerAccount)
    {
        ...
        try
        {
            ...
            while (Rd1.Read())
            {
                tmpValue1 = double.Parse(Rd1["TotalMoney"].ToString());         //240000.0
            }
            Rd1.Close();
