...
public partial class Customer_MyProfile : System.Web.UI.Page
{
    ...
    public string strName = "", strAddress = "", strPhone = "", strBirthday = "", strIdCard = "", strEmail = "", strMsg = "",strDaycreate="",strCard = "",strCMND="";
    private string Id = "";
    ...
    public void getCustomer()
    {
        ...
        while (Rd.Read())
        {
            ...
            try
            {
                this.strDaycreate = DateTime.Parse(Rd["DayCreateAccount"].ToString()).ToString("dd/MM/yyyy");
            }
            catch
            {
            ...
            this.strCMND = Rd["IdCard"].ToString();
            lblImg1.Text = "<img  height = \"120px\" src = \"" + Rd["Avatar"].ToString() + "\">";
